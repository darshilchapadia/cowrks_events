...
module.exports = NodeHelper.create({
	...
	socketNotificationReceived: function(notification, payload) {
		if (notification === "ADD_EVENTS") {
			console.log("Getting data form give URL:==> ", payload.feed)
	...
	createFetcher: function(feed, config) {
		...
		if (typeof self.fetchers[url] === "undefined") {
			console.log("Create new cowrks event fetcher for url: " + url + " - Interval: " + reloadInterval);
			...
			console.log("Use existing cowrks event fetcher for url: " + url);
